    ...
    try {
        ...
        var transport = nodemailer.createTransport({
          ...
          const mailOptions = {
            ...
            html: `<p>Click <a href="${process.env.DOMAIN}/${emailType === "VERIFY" ? "verifyemail" : "reset"}?token=${hashedToken}">here</a> to ${emailType === "VERIFY" ? "Verify your email." : "Reset your password."}
