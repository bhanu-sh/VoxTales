...
import MusicPlayer from "@/app/components/MusicPlayer/page";
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen py-2">
      ...
      {podcast && (
        ...
        //   <audio controls src={podcast.audio} />
        //   <>
        ...
        //               Now Playing
        //             </p>
        //             <h2 className="text-slate-900 transition-all duration-500 dark:text-slate-50 text-lg">
        //               {podcast.title}
        //             </h2>
        //             <p className="text-slate-500 transition-all duration-500 dark:text-slate-400 text-sm leading-6 truncate">
        //               {podcast.description}
        //             </p>
        //           </div>
        //         </div>
        ...
        //         </div>
        //       </div>
        //       <div className="bg-slate-50 text-slate-500 dark:bg-slate-600 transition-all duration-500 dark:text-slate-200 rounded-b-xl flex items-center">
        ...
        //           <button
        //             type="button"
        //             className="rounded-lg text-xs leading-6 font-semibold px-2 ring-2 ring-inset ring-slate-500 text-slate-500 dark:text-slate-100 dark:ring-0 transition-all duration-500 dark:bg-slate-500"
        //           >
        //             1x
        //           </button>
        //         </div>
