...
export default function SignupPage() {
  ...
  const activeStyle = "border-b-4 border-blue-400 mb-5";
  ...
  return (
    <div className="flex flex-col w-96 mx-auto justify-center min-h-screen">
      ...
      <div className="flex">
        <button
          className={"mx-auto w-48 px-4" + (userType === "User" ? activeStyle : "")}
          onClick={() => setUserType("User")}
        >
          User
        </button>
        <button
          className={"mx-auto w-48 px-4" + (userType === "Artist" ? activeStyle : "")}
