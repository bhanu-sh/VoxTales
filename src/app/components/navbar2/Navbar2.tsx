...
const Navbar = () => {
  ...
  const [currentNavigation, setCurrentNavigation] = useState<NavigationItem[]>(navigation);
  ...
  }, [router.pathname, currentNavigation]);
                  ...
                  <div>
                    {
                      ...
                      />
                        ...
                        <Link href="/login"className="text-gray-300 hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium">
                          Login
                        </Link>
                      )
                    }
